...
public class MainActivity extends FragmentActivity implements LocationListener,
  ...
  // The update interval -- 1 minute (NAREN)
...
*/
  ...
  public void onLocationChanged(Location location) {
    ...
    final ParseGeoPoint myPoint = geoPointFromLocation(lastLocation);

    // Create a post.
    AnywallPost post = new AnywallPost();
    // Set the location to the current user's location
    post.setLocation(myPoint);
    post.setText("Updated : " + new Date() + " Lat/Long : "+ myPoint.getLatitude()+"/"+ myPoint.getLongitude());
    post.setUser(ParseUser.getCurrentUser());
    ParseACL acl = new ParseACL();
    // Give public read access
    acl.setPublicReadAccess(true);
